...
record() {
  ...
  ffmpeg -f x11grab -s 1360x768 -framerate 60 -i :0.0 -f pulse -i  default -c:v libx264 -preset veryfast -tune zerolatency -b:v 3500k -maxrate 3500k -minrate 3500k -bufsize 3500k -g 60 -pix_fmt yuv420p -c:a aac -b:a 128k  -threads 0 -f flv "rtmp://live.twitch.tv/app/$TWITCHKEY" & echo $! > /tmp/recpid
